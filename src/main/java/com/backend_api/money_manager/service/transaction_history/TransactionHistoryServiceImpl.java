...
public class TransactionHistoryServiceImpl implements TransactionHistoryService{
    ...
    public ResponseEntity<Object> createTransaction(TransactionRequest request) {
        ...
        try{
            ...
            System.out.println(balance);
            System.out.println("=== categoryAction getName expand ===");
            System.out.println(categoryAction.getName().equals("Expend"));
            System.out.println("=== categoryAction getName income ===");
            System.out.println(categoryAction.getName().equals("Income"));
